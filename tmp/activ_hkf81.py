...
Pbar_range[1,  250,  500,  750, 1000, 1500, 2000, 3000, 4000, 5000]
# (sqrt(kg/mol))
Agamma
...
# HKF solvation parameter, kg/cal, multiplied by 1.0e+07.
bNaCl
...
# HKF short-range interaction parameter, kg/mol, multiplied by 1.0e+02.
bNapClm 
