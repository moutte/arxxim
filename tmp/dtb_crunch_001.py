...
# crunch dtb from crunch site
lisMaj=['H2O','H+','O2(aq)','SiO2(aq)','Al+3','Fe+2','Mg+2','Ca+2','Na+','K+']
lisAni=['HCO3-','Cl-','F-','HPO4-2','SO4-2','B(OH)3(aq)','NO3-']
lisTrc=['Mn+2','CrO4-2','Ni+2','Cu+2','Zn+2','MoO4-2','H2AsO4-','Sr+2','Ba+2','Pb+2']
